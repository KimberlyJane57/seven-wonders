...
fetch(
  "http://localhost:8080/https://api.content.tripadvisor.com/api/v1/location/search?key=29CB0A3EE8A74953A71A7964758809DA&searchQuery=Tiger%27s%20Nest%20Monastery%2C%20Bhutan&category=Hotels&language=en",
  options
)
...
function tripAdvisorDetails(data) {
  for (var i = 0; i < 4; i++) {
    if (data[i].location_id !== "16661530") {
      fetch(
